                        ...
                        </form>
                        {
                            ...
                            (
                                <div className="served-patients_dsp">
                                    ...
                                    <h4>{records[0].detail_history_record ? records[0].detail_history_record.patient_name : records[0].patient_name}</h4>
                                    {records.map((record) => (
                                        <div className="personal-info_dsp">
                                            ...
                                            {record.is_redirection_served === true && (<div>
                                                ...
                                                {
                                                    record.detail_history_record.staff_designation === "Doctor" && record.detail_history_record.lab_testing_to_be_done && (
                                                        <span>
                                                            <p>Lab testing to be done: </p>
                                                            <ol>
                                                                {record.detail_history_record.lab_testing_to_be_done.map((test) => (
                                                                    <li>{test}</li>
                                                                ))}
                                                            </ol>
                                                        </span>
                                                ...
                                                {
                                                    record.detail_history_record.staff_designation === "Doctor" && record.detail_history_record.medicines_prescribed && (
                                                        <span>
                                                            <p>Medicines prescribed: </p>
                                                            <ol>
                                                                {JSON.stringify(record.detail_history_record.medicines_prescribed)}
                                                            </ol>
                                                        </span>
                                                    )
                                                }
